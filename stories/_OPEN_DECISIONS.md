...
- **Ziel-Konzept:** FK-69 (neuer Per-Check-Read-Model-Eintrag) / verify-system / telemetry · **Status:** ENTSCHIEDEN → **AG3-108 neu geschnitten (L)**; Codex-Re-Review + Implementierung offen.
