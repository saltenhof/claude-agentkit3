...
| AG3-122 | Install-Dreifaltigkeit: `serve`/`update`/`detach`/`decommission` + `install`-Rückbau | F | L | in_progress | 121 |
...
**Sofort startbar (`ready`):** AG3-124, AG3-125, AG3-127. (AG3-120, AG3-121, AG3-123, AG3-126 ✅ completed; AG3-122 in Arbeit.)
