...
(``agentkit.backend.verify_system.structural.checks.artifact_checks``): ONE consistent
...
from agentkit.backend.core_types import HANDOVER_FILE, ArtifactClass, EnvelopeStatus
from agentkit.backend.implementation.register import (
...
if TYPE_CHECKING:
    ...
    from agentkit.backend.implementation.worker_loop.loop import IncrementResult
    from agentkit.backend.implementation.worker_session.session import WorkerSession
