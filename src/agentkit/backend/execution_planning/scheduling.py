...
from agentkit.backend.execution_planning.readiness import derive_plan
...
def _completed_from_statuses(stories: Sequence[StoryRefForPlanning]) -> set[str]:
    from agentkit.backend.execution_planning.readiness import completed_story_ids_from_statuses
