...
from agentkit.backend.execution_planning.planning_model.proposal import ProposalStatus
from agentkit.backend.execution_planning.proposal_ingest.errors import (
...
if TYPE_CHECKING:
    ...
    from agentkit.backend.execution_planning.planning_model.metadata import Provenance
