...
Failure Corpus via :meth:`~agentkit.backend.failure_corpus.top.FailureCorpus.record_incident`.
...
def to_corpus_incident_candidate(
    ...
    Returns:
        A :class:`~agentkit.backend.failure_corpus.incident.IncidentCandidate` ready
        for :meth:`~agentkit.backend.failure_corpus.top.FailureCorpus.record_incident`.
    """
