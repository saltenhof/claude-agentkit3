...
class AdjudicationSeverity(StrEnum):
    ...
    Mirrors :class:`~agentkit.backend.failure_corpus.types.IncidentSeverity` wire values
...
class GovernanceIncidentCandidate(BaseModel):
    ...
    Distinct from :class:`~agentkit.backend.failure_corpus.incident.IncidentCandidate`
