...
if TYPE_CHECKING:
    from agentkit.backend.governance.guard_evaluation import Operation
...
def main() -> None:
    ...
    :class:`~agentkit.backend.governance.ccag.runtime.CcagPermissionRuntime`,
    ...
    """
    from agentkit.backend.governance.ccag.rules import OPAQUE_MESSAGE
