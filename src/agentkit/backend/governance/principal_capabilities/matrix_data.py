...
loader (:class:`~agentkit.backend.governance.principal_capabilities.matrix.CapabilityMatrix`)
...
from agentkit.backend.governance.principal_capabilities.operations import OperationClass as Op
from agentkit.backend.governance.principal_capabilities.paths import PathClass as Pc
from agentkit.backend.governance.principal_capabilities.principals import Principal as Pr
