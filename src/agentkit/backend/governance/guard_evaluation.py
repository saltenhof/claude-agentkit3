...
def _is_integration_stabilization_story(
    ...
    Truth-boundary discipline (TB003): ``agentkit.backend.governance`` is a protected
    ...
    from agentkit.backend.integration_stabilization.state import IS_MANIFEST_FILE
...
def _maybe_seam_guard(
    ...
    *,
    ...
    :class:`~agentkit.backend.integration_stabilization.seam_allowlist_guard.FailClosedSeamGuard`
