...
:mod:`agentkit.backend.governance.guard_system.protected_paths` (SINGLE SOURCE OF TRUTH;
...
:func:`agentkit.backend.governance.runner._run_self_protection_guard` for the
...
if TYPE_CHECKING:
    ...
    from agentkit.backend.governance.principal_capabilities.paths import PathClassifier
