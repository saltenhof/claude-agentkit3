...
:mod:`agentkit.backend.core_types.qa_artifact_names` (``STRUCTURAL_PRODUCER`` etc.) — the
...
from agentkit.backend.governance.integrity_gate import _dimension_specs as _specs
from agentkit.backend.governance.integrity_gate._dimension_specs import IntegrityDimension
from agentkit.backend.story_context_manager.types import StoryType
from agentkit.backend.verify_system import verify_decision_passed
...
if TYPE_CHECKING:
    ...
    from agentkit.backend.governance.repository import IntegrityGateStatePort
...
def evaluate_mandatory_artifact(
    ...
    *,
    ...
    """
    from agentkit.backend.governance.integrity_gate import DimensionResult
