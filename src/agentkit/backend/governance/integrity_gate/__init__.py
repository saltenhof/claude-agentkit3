...
(``agentkit.backend.bootstrap.composition_root.build_integrity_gate``) is the canonical
...
class IntegrityGate:
    ...
    def _resolve_sonar_applicable(
        ...
        *,
        ...
        """
        from agentkit.backend.story_context_manager.types import StoryType as _StoryType
