...
if TYPE_CHECKING:
    ...
    from agentkit.backend.failure_corpus.incident_triage import IncidentTriage
    from agentkit.backend.failure_corpus.pattern_promotion import PatternPromotion
