...
``IncidentStatus`` is the canonical SSOT in ``agentkit.backend.core_types`` (CONFLICT-1)
...
from agentkit.backend.failure_corpus.errors import FailureCorpusError, IncidentRejectedError, IncidentRejectReason
from agentkit.backend.failure_corpus.incident import Incident, IncidentCandidate, IncidentDraft
from agentkit.backend.failure_corpus.incident_triage import IncidentNormalizer, IncidentTriage, IngressCriteria
...
from agentkit.backend.failure_corpus.ports import IncidentWriterPort, ProjectionReaderPort
...
from agentkit.backend.failure_corpus.types import CheckId, IncidentId, IncidentRole, IncidentSeverity, PatternId
