...
if TYPE_CHECKING:
    from agentkit.backend.pipeline_engine.phase_envelope.repository import (
        PhaseEnvelopeRepository,
    )
    from agentkit.backend.pipeline_engine.phase_executor.models import PhaseName, PhaseState
