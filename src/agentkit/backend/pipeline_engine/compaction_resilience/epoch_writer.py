...
from agentkit.backend.pipeline_engine.compaction_resilience.epoch_store import (
    CompactionEpochRepository,
    build_epoch_repository,
)
from agentkit.backend.pipeline_engine.compaction_resilience.hook_io import (
    hook_cwd,
    load_json_file,
    read_hook_input,
    warn,
)
from agentkit.backend.pipeline_engine.compaction_resilience.models import StoryMarker
from agentkit.backend.pipeline_engine.compaction_resilience.paths import STORY_MARKER_FILENAME
