...
if TYPE_CHECKING:
    ...
    from agentkit.backend.verify_system.protocols import RunScope, StoryContextQueryPort
...
def materialize_qa_prompt_audit(
    *,
    ...
    from agentkit.backend.prompt_runtime import ComposeConfig, PromptRuntime
