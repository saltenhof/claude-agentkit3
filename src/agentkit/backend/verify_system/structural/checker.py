...
class StructuralChecker:
    ...
    :class:`~agentkit.backend.verify_system.protocols.QALayer` protocol.
...
def _check_is_manifest_approval_required(
    ...
    *,
    ...
    """
    del ctx
    from agentkit.backend.integration_stabilization.state import load_manifest_approval
    from agentkit.backend.verify_system.protocols import TrustClass
...
def _check_is_binding_integrity(
    ...
    *,
    ...
    """
    from agentkit.backend.integration_stabilization.preconditions import check_binding_integrity
...
def _check_is_stabilization_budget_not_exhausted(
    ...
    *,
    ...
    from agentkit.backend.integration_stabilization.state import load_integration_manifest
    from agentkit.backend.verify_system.protocols import TrustClass
