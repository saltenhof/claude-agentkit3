...
if TYPE_CHECKING:
    ...
    from agentkit.backend.verify_system.evidence.assembler import EvidenceAssemblyResult
    ...
    from agentkit.backend.verify_system.evidence.request_types import RequestResult, ReviewerRequest
