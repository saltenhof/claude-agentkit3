...
_EXPORT_MODULE_NAMES = {
    ...
    "agentkit.backend.bootstrap.composition_verify": (
        ...
        "build_artifact_invalidation_sink", "build_github_code_backend_port", "build_push_barrier_evidence",
...
_PUBLIC_NAMES = (
    ...
    "build_exploration_drafting", "build_exploration_phase_handler", "build_exploration_review",
    "build_failure_corpus", "build_github_code_backend_port", "build_integrity_gate",
