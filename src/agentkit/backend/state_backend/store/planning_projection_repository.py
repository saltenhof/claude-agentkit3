...
from agentkit.backend.execution_planning.persistence.repositories import (
    PlanningProjectionRepositories,
)
from agentkit.backend.state_backend.store._planning_ddl import (
...
def build_planning_projection_repositories(
    ...
    ``agentkit.backend.bootstrap.composition_root.build_planning_projection_accessor``.
