...
def load_manifest_approval(
    ...
    """
    from agentkit.backend.integration_stabilization.models import ManifestApprovalRecord
...
def save_manifest_approval(
    ...
    :func:`agentkit.backend.integration_stabilization.events.emit_integration_manifest_approved`)
...
def apply_reclassification_no_retroactive_legalization(
    ...
    *,
    ...
    Returns:
        A :class:`~agentkit.backend.integration_stabilization.preconditions.ReclassificationCheckResult`
