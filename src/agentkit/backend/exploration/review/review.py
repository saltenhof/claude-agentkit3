...
from agentkit.backend.exploration.review.design_challenge import DesignChallengeResult
    ...
    def run(
        ...
        Args:
            ...
            run_design_challenge: Mandate-gating for the OPTIONAL Stage-2b design
                ...
                :attr:`~agentkit.backend.exploration.mandate.classification.MandateClassificationResult.run_design_challenge`.
