...
output (FK-23 §23.3.2) into a validated :class:`~agentkit.backend.exploration.change_frame.ChangeFrame`
...
from agentkit.backend.exploration.drafting.ports import (
