...
if TYPE_CHECKING:
    ...
    from agentkit.backend.exploration.drafting.drafting import ExplorationDrafting
    ...
    from agentkit.backend.exploration.ports import (
        ChangeFrameReader,
        DeclaredImpactReader,
        RunScopeResolver,
        WorkerDraftPresenceReader,
    )
    from agentkit.backend.exploration.review import ExplorationGateResult, ExplorationReview
...
class ExplorationPhaseHandler:
        ...
        *,
        ...
        Args:
            ...
            review: The three-stage exploration exit-gate
                (:class:`~agentkit.backend.exploration.review.ExplorationReview`,
    ...
    def _classify_and_route(
        ...
        *,
        ...
        """
        from agentkit.backend.exploration.mandate.classification import MandateClass
