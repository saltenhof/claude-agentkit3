...
:class:`~agentkit.backend.exploration.mandate.hub_fine_design.HubFineDesignEvaluator` is
...
* :class:`LlmConvergenceJudge` -- delegates the convergence verdict to an injected
  :class:`~agentkit.backend.verify_system.llm_evaluator.llm_client.LlmClient` (the SAME
