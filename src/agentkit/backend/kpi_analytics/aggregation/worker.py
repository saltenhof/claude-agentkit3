...
from agentkit.backend.kpi_analytics.fact_store.models import FactGuardPeriod, SyncState

if TYPE_CHECKING:
    from agentkit.backend.kpi_analytics.aggregation.dirty_sets import DirtySets
    from agentkit.backend.kpi_analytics.aggregation.source_port import AnalyticsSourcePort
