...
from agentkit.backend.kpi_analytics.views import (
    DashboardView,
    DashboardViewStatus,
    DesignTokens,
    KpiResult,
...
if TYPE_CHECKING:
    ...
    from agentkit.backend.kpi_analytics.catalog import KpiCatalog, KpiDefinition
    from agentkit.backend.kpi_analytics.fact_store import FactStore
    from agentkit.backend.kpi_analytics.fact_store.models import FactStory, KpiQueryFilter, PeriodFilter
    from agentkit.backend.kpi_analytics.views import DashboardFactRow
