...
if TYPE_CHECKING:
    ...
    from agentkit.backend.process.language.gates import ExplorationGateStageSpec, Gate
    from agentkit.backend.process.language.guards import GuardFn
        ...
        *,
        ...
        Args:
            ...
            gate_stage: Optional typed exploration-gate stage this yield-point
                ...
                :class:`~agentkit.backend.process.language.gates.ExplorationGateStageSpec`
