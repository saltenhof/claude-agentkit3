...
from agentkit.backend.execution_planning.readiness import derive_budgets
...
if TYPE_CHECKING:
    ...
    from agentkit.backend.requirements_coverage.contract import AreEvidence, CoverageVerdict
