...
(:class:`~agentkit.backend.verify_system.llm_evaluator.prompt_materializer.PromptRuntimeMaterializer`)
...
NOT a :class:`~agentkit.integration_clients.vectordb.VectorDbError`: the VectorDB is
...
from agentkit.backend.story_creation.create_scope_materializer import (
...
class CreateTimeConflictAdjudicationError(Exception):
    ...
    :class:`~agentkit.integration_clients.vectordb.VectorDbError` /
    :class:`~agentkit.integration_clients.vectordb.VectorDbUnavailableError`: the
...
class CreateTimeConflictAdjudicator:
    ...
    :class:`~agentkit.backend.story_creation.vectordb_reconciliation.VectorDbReconciliation`
        ...
        *,
        ...
        Args:
            llm_client: The FK-65 / FK-11 LLM transport port (the SAME
                ...
                :class:`~agentkit.backend.verify_system.llm_evaluator.llm_client.HubLlmClient`).
