...
* **Conflict flag (§21.12 / §21.4.1):** the producer rule
  :func:`~agentkit.backend.story_creation.vectordb_reconciliation.resolve_vectordb_conflict_flag`
...
* **Repo affinity (§21.9):** :func:`~agentkit.backend.story_creation.repo_affinity.resolve_repo_affinity`
...
:meth:`agentkit.backend.story_context_manager.service.StoryService.create_story`
...
if TYPE_CHECKING:
    ...
    from agentkit.backend.story_creation.vectordb_reconciliation import ConflictEvaluatorPort
