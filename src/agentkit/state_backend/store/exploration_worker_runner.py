...
The bloodgroup-A :class:`~agentkit.exploration.drafting.drafting.ExplorationDrafting`
core obtains the worker-produced change-frame through the
:class:`~agentkit.exploration.drafting.ports.ExplorationWorkerRunner` boundary
...
from agentkit.core_types.qa_artifact_names import CHANGE_FRAME_DRAFT_FILE
