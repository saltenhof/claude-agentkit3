...
(:class:`~agentkit.governance.principal_capabilities.freeze.ConflictFreezeOverlay`).
...
from agentkit.core_types.plane_artifact_names import GOVERNANCE_FREEZE_EXPORT_PARTS
from agentkit.utils.io import atomic_write_text, read_json_object
...
class LocalFreezeJsonExport:
    ...
    Implements the
    :class:`~agentkit.governance.principal_capabilities.freeze.LocalFreezeExport`
