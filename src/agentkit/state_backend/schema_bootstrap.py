...
Both :mod:`agentkit.state_backend.postgres_store` and every
``StateBackend*`` repository under :mod:`agentkit.state_backend.store` use this
...
The schema name comes from :func:`agentkit.state_backend.config.resolve_schema_name`
