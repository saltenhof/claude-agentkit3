...
Templates use Python str.format() placeholders: {story_id}, {title}, etc.
Each template is a constant string, making them easy to test and version.
"""
...
"""Registry mapping template names to their template strings."""
