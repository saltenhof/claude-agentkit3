...
def shipped_skill_bundles_root() -> Path:
    ...
    Python-free resources tree (``src/agentkit/resources/skill_bundles/``).
    ...
    """
    package_dir = Path(__file__).resolve().parent.parent  # .../agentkit
    return package_dir / "resources" / "skill_bundles"
