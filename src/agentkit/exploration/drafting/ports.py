...
``agentkit.exploration.drafting`` is a bloodgroup-A domain core
...
call). The bloodgroup-A :class:`~agentkit.exploration.drafting.drafting.ExplorationDrafting`
...
class ExplorationWorkerResult:
    ...
    :class:`~agentkit.exploration.change_frame.ChangeFrame`.
