...
4. persist it BOTH as the protected ``_temp/qa/{story_id}/change_frame.json``
   file (via the AG3-045 :class:`~agentkit.exploration.ports.ChangeFrameWriter`
...
if TYPE_CHECKING:
    ...
    from agentkit.exploration.drafting.persistence import ChangeFrameSink
    from agentkit.exploration.drafting.ports import ExplorationWorkerRunner
    from agentkit.exploration.ports import ChangeFrameWriter
