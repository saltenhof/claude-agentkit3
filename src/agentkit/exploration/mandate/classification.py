...
from agentkit.exploration.mandate.impact_checker import ImpactExceedanceResult
from agentkit.exploration.mandate.scope_detector import ScopeExplosionResult
