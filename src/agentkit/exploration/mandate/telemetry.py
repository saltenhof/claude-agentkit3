...
``agentkit.telemetry.events.MANDATORY_PAYLOAD_FIELDS`` (validated fail-closed by
...
Emission goes through an injected :class:`~agentkit.telemetry.emitters.EventEmitter`
