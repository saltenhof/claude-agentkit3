...
auditable :class:`~agentkit.artifacts.reference.ArtifactReference` -- never a
...
authorized write surface (:class:`~agentkit.artifacts.manager.ArtifactManager`,
...
from agentkit.exploration.review.register import EXPLORATION_REVIEW_PRODUCER
