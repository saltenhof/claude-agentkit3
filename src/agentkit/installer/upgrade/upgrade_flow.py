...
the upgrade :class:`~agentkit.installer.upgrade.engine.UpgradeRequest`, constructs
the SHARED AG3-088 :class:`~agentkit.installer.checkpoint_engine.engine.CheckpointEngine`
over the upgrade :func:`~agentkit.installer.upgrade.engine.build_upgrade_flow`
...
if TYPE_CHECKING:
    ...
    from agentkit.installer.upgrade.footprint import CustomizationFootprint
