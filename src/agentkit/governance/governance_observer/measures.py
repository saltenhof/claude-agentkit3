...
value.  The :class:`~agentkit.governance.governance_observer.observer.GovernanceObserver`
...
def select_measure(
    ...
    :meth:`~agentkit.governance.governance_observer.observer.GovernanceObserver.handle_signal`
