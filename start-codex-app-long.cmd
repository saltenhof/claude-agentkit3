...
rem Start Codex Desktop App in this project with the 1M long context.
chcp 65001 >nul 2>&1
...
echo [INFO] Starte Codex App - Long Context
echo [INFO] Workdir: %WORKDIR%
echo [INFO] Context: %CONTEXT_WINDOW%, Auto-Compact: %AUTO_COMPACT%

start "Codex App [long]" "%CODEX_EXE%" -c model_context_window=%CONTEXT_WINDOW% -c model_auto_compact_token_limit=%AUTO_COMPACT% app "%WORKDIR%"
