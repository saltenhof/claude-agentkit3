...
| `16_qa_telemetrie_aggregation_dashboard.md` | QA-Telemetrie, Read-Models, Verdichtung, Dashboard-Vorbereitung |
...
| `67_artefakt_envelope_und_stage_registry.md` | Artefaktklassen + Ownership, Envelope-Schema mit LLM-Status-Mapping, Lock-Record-Mechanismus für QA-Artefaktschutz, typisierte Stage-Registry |
...
und Komponentenarchitektur (FK-65 §65.4 fuehrt den normativen
Top-Level-Schnitt). Pro Eintrag kann optional ein `component_family`
gefuehrt werden, der gegen die FK-65-Familien abgleicht.
