...
| `30_hook_adapter_guard_enforcement.md` | governance-and-guards | Harness-Hooks (Claude Code, Codex; harness-spezifisch via Adapter, FK-30 §30.11), Registrierung, Event-Normalisierung |
