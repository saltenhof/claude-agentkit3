...
| `37_verify_context_und_qa_bundle.md` | verify-system | QaContext (vier Werte: IMPLEMENTATION_INITIAL/IMPLEMENTATION_REMEDIATION/EXPLORATION_INITIAL/EXPLORATION_REMEDIATION) als Subflow-internes Diskriminator-Feld auf `ImplementationPayload`, Context Sufficiency Builder, Section-aware Bundle-Packing, Vertragsprofil integration_stabilization, HARD-BLOCKER fuer fehlende LLM-Reviews |
...
| `42_ccag_tool_governance_permission_runtime.md` | governance-and-guards | registrierter Hook-Identifier und autoritaetsloser Matcher-Katalog |
