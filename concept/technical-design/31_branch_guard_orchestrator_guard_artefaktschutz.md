...
direkt mit dem Harness (Claude Code / Codex; FK-76) und
...
1. **Harness-Hook-Kontext (Claude Code / Codex; FK-76 §76.4):** `is_subagent`-Aequivalent (vom Harness-Adapter auf das harness-neutrale `principal_kind`-Feld normalisiert) — wenn `main`,
...
nicht als Harness-Agent (Claude Code / Codex; FK-76), sondern
...
(FK-76 §76.5). Beispiel anhand Claude Code (`.claude/settings.json`;
