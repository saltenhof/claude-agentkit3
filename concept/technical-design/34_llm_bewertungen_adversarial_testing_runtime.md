...
# 34 — LLM-Bewertungen-Runtime

<!-- PROSE-FORMAL: formal.llm-evaluations.entities, formal.llm-evaluations.state-machine, formal.llm-evaluations.invariants -->
...
> Schicht 3 (Adversarial Testing Runtime mit Agent-Spawn,
> Adversarial-Prompt, Sandbox-Management, Test-Promotion,
> Sparring-Protokoll, Ergebnis-Artefakt und Telemetrie) sowie
> Mandatory Adversarial Targets sind normativ in **FK-48
> (Adversarial-Testing-Runtime)** beschrieben.
...
## 34.10 Mandatory Adversarial Targets

> Mandatory Adversarial Targets (Motivation, AdversarialTarget-Datenmodell, Prompt-Erweiterung, Ergebnis-Schema-Erweiterung adversarial.json, Gate-Rückkopplung Layer 3 → Layer 2, Abgrenzung) sind normativ in **FK-48 §48.2 (Adversarial-Testing-Runtime)** beschrieben.
