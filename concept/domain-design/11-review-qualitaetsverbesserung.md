---
concept_id: DK-11
title: Review-Qualitätsverbesserung
module: review-quality
domain: verify-system
status: active
doc_kind: core
parent_concept_id: DK-04
authority_over:
...
Review-Qualitätsverbesserung (Track A — Sparring-Reviews; Track B —
StructuredEvaluator). Die technischen Spezifikationen liegen in
**FK-28** (Evidence Assembler), **FK-46** (Import-Resolver),
**FK-47** (Request-DSL und Preflight-Turn) und **FK-37**
...
`07_komponentenarchitektur_und_architekturkonformanz.md` statt
