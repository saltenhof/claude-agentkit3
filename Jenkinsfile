            ...
            steps {
                dir('agentkit-src') {
                    sh '''
                        ...
                        # network and is reached by CONTAINER NAME on the internal port 55432
                        # (NOT 5432: the AK3 test fixture fail-closes on the reserved
                        # production standard port 5432).
